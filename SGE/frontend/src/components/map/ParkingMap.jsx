...
const getFill = (space) => {
  ...
  if (space.type === 'MOTORCYCLE') return '#f97316';
  ...
  return (
    <div className="parking-shell">
      ...
      <div className="parking-map-card">
        <svg viewBox="0 0 1600 1100" className="parking-svg" role="img" aria-label="Mapa de cajones de estacionamiento">
          <polygon
      ...
      <div className="parking-legend">
        ...
        <LegendDot color="#f97316" label="Moto" />
