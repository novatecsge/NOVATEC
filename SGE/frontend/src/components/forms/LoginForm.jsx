    ...
    <div className="auth-shell">
      <section className="auth-hero">
        ...
        <div style={{ maxWidth: 620 }}>
          ...
          <p style={{ color: '#cbd5e1', fontSize: 18, lineHeight: 1.6 }}>Acceso QR, mapa operativo en tiempo real, reservas y dashboards.</p>
        </div>
        <div style={{ color: '#94a3b8', fontWeight: 800 }}>© NOVATEC · v2.0</div>
      </section>
      <form onSubmit={onSubmit} className="auth-card auth-form">
        ...
        <input name="email" placeholder="Correo institucional" value={form.email} onChange={onChange} autoComplete="username" />
